...
contract Perpustakaan {
    ...
    function addBook(string memory isbn, string memory judul, uint256 tahun, string memory penulis) public onlyOwner {
        ...
        token.transfer(msg.sender, 1_000_000_000_000_000_000); // 1 * 10**18
        emit BookAdded(isbn);
    }
